// Model Feb 5, 2025
// first attempt at splitting experiential effect into two seperate winner and loser effects
...
data {
  ...
  vector[N] win_ind;                   // indicating whether last game was a win
  vector[N] lose_ind;                  // indicating whether last game was a lose - not needed I think but will help with interpretability
}
